...
var builtinOidsArray = []string{
	...
	2609: `min(arg1: macaddr) -> anyelement`,
	2610: `percentile_disc_impl(arg1: float, arg2: macaddr) -> macaddr`,
	2611: `array_agg(arg1: macaddr) -> macaddr[]`,
	2612: `percentile_disc_impl(arg1: float[], arg2: macaddr) -> macaddr[]`,
	2613: `array_cat_agg(arg1: macaddr[]) -> macaddr[]`,
	2614: `array_agg(arg1: macaddr[]) -> macaddr[][]`,
	2615: `max(arg1: macaddr) -> anyelement`,
	2616: `array_cat(left: macaddr[], right: macaddr[]) -> macaddr[]`,
	2617: `array_prepend(elem: macaddr, array: macaddr[]) -> macaddr[]`,
	2618: `array_remove(array: macaddr[], elem: macaddr) -> anyelement`,
	2619: `array_append(array: macaddr[], elem: macaddr) -> macaddr[]`,
	2620: `array_positions(array: macaddr[], elem: macaddr) -> int[]`,
	2621: `array_replace(array: macaddr[], toreplace: macaddr, replacewith: macaddr) -> anyelement`,
	2622: `array_position(array: macaddr[], elem: macaddr) -> int`,
	2623: `array_position(array: macaddr[], elem: macaddr, start: int) -> int`,
	2624: `macaddrsend(macaddr: macaddr) -> bytes`,
	2625: `macaddrout(macaddr: macaddr) -> bytes`,
	2626: `macaddrrecv(input: anyelement) -> macaddr`,
	2627: `macaddrin(input: anyelement) -> macaddr`,
	2628: `nth_value(val: macaddr, n: int) -> macaddr`,
	2629: `lead(val: macaddr) -> macaddr`,
	2630: `lag(val: macaddr) -> macaddr`,
	2631: `lag(val: macaddr, n: int) -> macaddr`,
	2632: `lag(val: macaddr, n: int, default: macaddr) -> macaddr`,
	2633: `first_value(val: macaddr) -> macaddr`,
	2634: `lead(val: macaddr, n: int) -> macaddr`,
	2635: `last_value(val: macaddr) -> macaddr`,
	2636: `lead(val: macaddr, n: int, default: macaddr) -> macaddr`,
}
